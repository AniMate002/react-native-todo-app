...
const TaskCard:React.FC<TaskCardPoprs> = ({ title, status, location, startDate, dueDate}) => {
    ...
    return (
        <View style={{backgroundColor: randomColor.bg}} className='w-full rounded-2xl py-4 px-6 mt-4'>
